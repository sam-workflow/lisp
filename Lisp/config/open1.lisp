...
(defparameter *open-swings*

  '(

      (cl.d1b short 106.33 20140625 105.09)

      (oj.d1b short 150.10 20140620 162.40)
      (ho.d1b short 3.0106 20140623 3.0234)
      (bo.d1b short 40.45 20140627 40.48)

    ))

(defparameter *c-list*
    '(
    (dj.d1b 0 "MAR16" "DOW JONES 30 E-mini" 1)
    (sp.d1b 2 "MAR16" "S&amp;P 500 E-mini" .25)
    (nd.d1b 2 "MAR16" "NASDAQ 100 E-mini" .25)
    (ru.d1b 2 "MAR16" "RUSSELL 2000 E-mini" .1)
    (nk.d1b 0 "MAR16" "NIKKEI 225 Globex" 5)

    (ty.d1b nil "MAR16" "10-YEAR T-NOTES" nil)
    (us.d1b nil "MAR16" "30-YEAR T-BONDS" nil)

    (gc.d1b 2 "FEB16" "GOLD" .10)
    (si.d1b 4 "MAR16" "SILVER" .0050)
    (cp.d1b 4 "MAR16" "COPPER" .0005)

    (pa.d1b 2 "MAR16" "PALLADIUM" .05)
    (pl.d1b 2 "JAN16" "PLATINUM" .10)

    (ad.d1b 4 "MAR16" "AUSTRALIAN DOLLAR" .0001)
    (bp.d1b 4 "MAR16" "BRITISH POUND" .0001)
    (cd.d1b 4 "MAR16" "CANADIAN DOLLAR" .0001)
    (e1.d1b 4 "MAR16" "EURO CURRENCY" .0001)
    (jy.d1b 4 "MAR16" "JAPANESE YEN" .0001)

    (mx.d1b 3 "MAR16" "MEXICAN PESO" .025)

    (sf.d1b 4 "MAR16" "SWISS FRANC" .0001)


    (cl.d1b 2 "JAN16" "CRUDE OIL" .01)
    (ho.d1b 4 "JAN16" "HEATING OIL" .0001)
    (hu.d1b 2 "JAN16" "RBOB GASOLINE" .01)

    (ng.d1b 3 "JAN16" "NATURAL GAS" .001)

    (ct.d1b 2 "MAR16" "COTTON" .01)
    (cc.d1b 0 "MAR16" "COCOA" 1)
    (cf.d1b 2 "MAR16" "COFFEE" .05)

    (lb.d1b 2 "JAN16" "LUMBER" .01)
    (oj.d1b 2 "JAN16" "ORANGE JUICE" .05)

    (su.d1b 2 "MAR16" "SUGAR" .01)

    (c.d1b 2  "MAR16" "CORN" .25)
    (s.d1b 2  "JAN16" "SOYBEANS" .25)
    (bo.d1b 2 "JAN16" "SOYBEAN OIL" .01)
    (sm.d1b 2 "JAN16" "SOYBEAN MEAL" .10)
    (w.d1b 2  "MAR16" "WHEAT CBOT" .25)

    (lc.d1b 3 "FEB16" "LIVE CATTLE" .025)
    (lh.d1b 3 "FEB16" "LEAN HOGS" .025)
